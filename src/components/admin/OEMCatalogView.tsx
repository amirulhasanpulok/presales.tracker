...
export const OEMCatalogView: React.FC<Props> = ({ oems, canManage, products = [], onCreate, onUpdate, onDelete }) => {
  ...
  const selected = oems.find(oem => oem.id === selectedId);
