...
for (const record of records) {
  ...
  if (!groups.has(clientKey)) groups.set(clientKey, { clientName: record.clientName, activities: [], sources: new Set(), scopes: new Set(), salesKams: new Set(), presalesEngineers: new Set(), lastStatus: '', statusSource: '', statusDate: null, boqSubmitted: false });
  ...
  if (/boq(?:\s*&\s*price)?\s*submitted/i.test(record.salesStatus || '')) group.boqSubmitted = true;
}
