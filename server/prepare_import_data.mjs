...
for (const record of records) {
  ...
  if (!groups.has(clientKey)) groups.set(clientKey, { clientName: record.clientName, activities: [], sources: new Set(), scopes: new Set(), lastStatus: '', statusSource: '', statusDate: null });
